...
Der Pseudocode in Ausschnitt~\ref{lst:errorDetection} zeigt dies visuell.
...
Nach jedem fehlgeschlagenen Versuch, außer dem Initialem, wird der Retry-Zähler erhöht, sodass die Anzahl der
...
Fehlerklasse.
Stattdessen wird lediglich der zurückgegebene SQLSTATE-Code erfasst.
