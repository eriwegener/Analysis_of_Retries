...
Um die Vergleichbarkeit und Stabilität der Ergebnisse zu gewährleisten, wird jedes Experiment fünfmal wiederholt.
Die Workload bleibt dabei mit 500 Transaktionen für alle Experimente konstant.
...
\begin{lstlisting}[language=Python, caption={Übersicht der Parameter}, label={lst:params}]
RETRY_COUNT = [0, 1, 3, 5]
