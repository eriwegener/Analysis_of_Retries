...
Dies wird für die fünf Concurrency-Werte getestet, die in Ausschnitt~\ref{lst:params} aufgezeigt sind.
...
verfälscht und die \emph{Retry after Delay} Strategie gewählt, weil die den Einfluss von Delay am besten zeigt, denn
...
welcher Anzahl an gleichzeitigen Anfragen eine Retry-Strategie umschlägt.
...
Die Iteration wird mit erfasst und mit dieser berechnet sich die statistische Unsicherheit.
