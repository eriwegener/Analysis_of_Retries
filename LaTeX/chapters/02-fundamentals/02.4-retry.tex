...
Wie im vorherigen Abschnitt schon angemerkt, sollten Transaktionen die in transient Failures geendet sind
wiederholt werden.
...
Eine weitere in dieser Arbeit behandelte Strategie ist \emph{Retry after Delay}.
...
den gleichen Effekt liefert.} sein~\cite{MicrosoftRetryPattern}.
