...
\label{sec:devenv}
\input{chapters/06-impementation/06.1-denenv}

\section{Aufbau der Software}
\label{sec:softwareDesign}
\input{chapters/06-impementation/06.2.softwareDesign}

\section{Fehlererkennung}
\label{sec:errorDetection}
\input{chapters/06-impementation/06.3-errorDetection}

\section{Implementierung der Experimente}
\label{sec:experimentImpl}
\input{chapters/06-impementation/06.4-experimentImpl}

\section{Konfiguration}
\label{sec:configuration}
\input{chapters/06-impementation/06.5-configuration}

\section{Implementierungsentscheidungen}
\label{sec:decisions}
\input{chapters/06-impementation/06.6-decisions}